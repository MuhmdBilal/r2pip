  ...
  return (
    <section className="flex flex-col items-center justify-center w-full py-3 gap-y-8">
      ...
      >
        ...
        <div className="flex flex-col items-center border-2 border-red1 p-4 rounded-xl md:items-start justify-center gap-y-8 w-fit max-w-[290px]">
          <h1 className="text-red1 text-3xl font-extrabold">Phase 2</h1>
          <div className="flex flex-col items-start gap-y-2">
            {[
              "Partner with Social Media Influencers",
              "Launch of DEX Advertisements",
